...
function MkButton({
    ...
    const baseStyles = 'flex items-center justify-center transition-colors duration-300' +
    ...
    const colorStyles: Record<string, Record<string, string>> = {
        ...
        outlined: {
            primary: 'border border-primary-700 text-primary-800 bg-white hover:bg-primary-100',
            neutral: 'border border-neutral-700 text-neutral-800 bg-white hover:bg-neutral-100',
            success: 'border border-success-700 text-success-800 bg-white hover:bg-success-100',
            info: 'border border-info-700 text-info-800 bg-white hover:bg-info-100',
            danger: 'border border-danger-700 text-danger-800 bg-white hover:bg-danger-100',
            warning: 'border border-warning-700 text-warning-800 bg-white hover:bg-warning-100'
        },
        transparent: {
    ...
    return (
        <button
            ...
            {...props}
        >
            <DynamicIcon name={ iconName } size={ iconSize[size] } className={ !iconOnly ? 'mr-2' : '' } />
